/* Form definition file generated by fdesign on Wed Feb 24 19:22:43 2016 */
...
create_form_menuattrib( void )
{
    ...
    obj = fl_add_labelframe( FL_ENGRAVED_FRAME, 225, 67, 111, 80, "Action" );
    ...
    obj = fl_add_button( FL_NORMAL_BUTTON, 235, 113, 84, 24, "Delete" );
    fl_set_button_shortcut( obj, "#D", 1 );
    fl_set_object_callback( obj, delete_menu_item_cb, 0 );

    obj = fl_add_button( FL_NORMAL_BUTTON, 245, 157, 64, 24, "<= Get" );
    ...
    obj = fl_add_button( FL_NORMAL_BUTTON, 245, 187, 64, 26, "=> Set" );
