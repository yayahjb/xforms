/* Form definition file generated by fdesign on Wed Feb 24 19:22:52 2016 */
...
FD_choiceattrib *
create_form_choiceattrib( void )
{
    FL_OBJECT *obj;
    FD_choiceattrib *fdui = ( FD_choiceattrib * ) fl_malloc( sizeof *fdui );
    ...
    obj = fl_add_labelframe( FL_ENGRAVED_FRAME, 225, 82, 111, 85, "Action" );
    ...
    obj = fl_add_button( FL_NORMAL_BUTTON, 245, 172, 64, 24, "<= Get" );
    ...
    obj = fl_add_button( FL_NORMAL_BUTTON, 245, 202, 64, 26, "=> Set" );
